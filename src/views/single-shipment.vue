...
const onSubmit = async (values: any) => {
  ...
  const payload = {
    ...
    pickup_option: values.pickup_option,
    recipient_address: values.pickup_location,
...
<template>
  ...
  <Form :validation-schema="shipmentSchema" @submit="onSubmit">
    <div>
        ...
        <div
                    ...
                    <section class="grid grid-cols-1 lg:grid-cols-2 lg:gap-4">
                      <section>
                        <section>
                          ...
                          <Field name="pickup_location" as="input" id="pickup-address" type="text"
                            placeholder="e.g. 17, Ogunyemi strt, Magodo."
                            class="font-normal text-sm leading-[18.2px] mt-2 flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2" />
                        </section>
                        <section class="mt-4">
                    ...
                    <section class="grid grid-cols-1 lg:grid-cols-2 lg:gap-4 mt-8">
                      <section>
                        <section>
                          ...
                          <Field name="recipient_name" as="input" id="receiver-name" type="text" placeholder="e.g. John"
                            class="font-normal text-sm leading-[18.2px] mt-2 flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2 " />
                        </section>
                        <section class="mt-4">
                          ...
                          <Field name="drop_off_location" as="input" id="drop-off" type="text"
                            placeholder="e.g. 17, Ogunyemi strt, Magodo."
                            class="font-normal text-sm leading-[18.2px] mt-2 flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2" />
                        </section>
                        <section class="mt-4">
                          ...
                          <Field id="delivery-notes" name="description" as="input" type="text"
                            placeholder="e.g. Kindly pickup from the gateman"
                            class="mb-4 font-normal text-sm leading-[18.2px] lg:mb-0 mt-2 flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2" />
                        </section>
                      </section>
                      <section>
                        <section>
                          ...
                          <Field name="recipient_email" as="input" id="delivery-email" type="email"
                        ...
                        <section class="mt-4">
                          ...
                          <div class="h-[42px] flex mt-2">
                            <FlagDropdown />
                            <Field placeholder="8023456789" name="recipient_phone" as="input" type="text"
                              class="h-full font-normal text-sm leading-[18.2px] w-[73.24%] rounded-s-none px-2 text-left flex  rounded-md border border-slate-200 bg-white py-2" />
                          </div>
                        </section>
                      </section>
                    </section>
                  ...
                  <TabsContent value="item-details" class="px-1 pb-1 mt-8">
                    <section class="flex justify-between items-center">
                      <section class="w-[49.14%]">
                        ...
                        <Field name="pickup_option" v-slot="{ field }">
                          <Select v-model="field.value" @update:modelValue="field.onChange">
                            <SelectTrigger class="mt-2">
                      ...
                      <section class="w-[49.14%]">
                        ...
                        <Field name="weight" id="package-weight" as="input"
                          class="font-normal text-sm leading-[18.2px] flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2  text-[#999999] mt-2"
          ...
          <div class="flex justify-between items-center px-6 mt-3">
            ...
            <section class="flex gap-x-2 items-center">
              ...
              <Button @click="handleNextTab" variant="secondary"

  ...
  <div>
    <header class="flex justify-between mb-8">
      ...
      <section class="hidden md:block">
        ...
        <Button
          @click="$router.push({ name: 'bulk-shipment-checkout' })"
          class="px-3 py-2"
        >
          Submit
    ...
    <main class="mb-20 md:mb-0">
      <section
        class="rounded-xl border border-[#E4E7EC] shadow-sm shadow-[#1018280D] mb-4"
      >
        ...
        <section
          class="flex flex-col md:flex-row justify-between items-center px-6 pt-2 pb-6"
        >
      ...
      <section
        class="flex justify-between items-center rounded-lg border border-[#E4E7EC] px-6 py-3 mb-4"
      >
        <span class="font-semibold text-base leading-7 text-[#101828]">
      ...
      >
        <div class="px-6 pt-4 mb-4">
          <div class="flex justify-between items-center mb-4">
            ...
            <Button
              class="lg:hidden border border-[#E4E4E4EE] px-3 py-2 gap-x-2 bg-white"
              variant="secondary"
            >
              <UploadIcon />
          ...
          <div class="flex justify-between items-center mt-2">
            <TabsList
              class="w-full md:w-[373.99px] h-[42px] rounded-lg p-[5px] bg-[#F5F7FA]"
            >
              <TabsTrigger
            ...
            <div class="flex gap-x-4 items-center">
              <Button
                class="hidden lg:flex border border-[#E4E4E4EE] px-3 py-2 gap-x-2 bg-white"
                variant="secondary"
              >
                <UploadIcon />
                <span>Upload csv</span>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger>
                  <Button
                    class="hidden md:inline-flex p-0 rounded-full"
                    variant="ghost"
                  >
                    <DotsVertical />
                  </Button>
          ...
          <Table>
            <TableHeader>
              <TableRow class="bg-[#F9FAFB]">
                ...
                <TableHead class="lg:w-[17.33%] py-3"
                  >Drop-Off Address</TableHead
                >
            ...
            <TableBody>
              <TableRow
                v-for="(recipientInfo, index) in recipientInfos"
                :key="index"
              >
                <TableCell>
                ...
                <TableCell>
                  <div
                    class="rounded-md border border-[#E4E7EC] px-2 w-[120px] lg:w-auto md:px-4 py-3"
                  >
                    <span
                      class="font-normal text-sm leading-[18.2px] text-[#101828]"
                      >{{ recipientInfo.recipientName }}</span
                    >
                  </div>
                </TableCell>
                <TableCell>
                  <div
                    class="rounded-md border border-[#E4E7EC] w-[100px] lg:w-auto px-4 py-3"
                  >
                    <span
                      class="font-normal text-sm leading-[18.2px] text-[#101828]"
                      >2</span
                ...
                <TableCell>
                  <div class="rounded-md border border-[#E4E7EC] px-4 py-3">
                    <span
                      class="font-normal text-sm leading-[18.2px] text-[#101828]"
                      >{{ recipientInfo.deliveryEmail }}</span
                    >
                  </div>
                </TableCell>
                <TableCell>
                ...
                <TableCell>
                  <div
                    class="rounded-md border border-[#E4E7EC] w-[140px] lg:w-auto px-4 py-3"
                  >
                    <span
                      class="font-normal text-sm leading-[18.2px] text-[#101828]"
                      >17, Ogunyemi strt, Magodo</span
                    >
                  </div>
                </TableCell>
                <TableCell>
                  <div
                    class="rounded-md border border-[#E4E7EC] w-[200px] lg:w-auto px-4 py-3"
                  >
                    <span
                      class="font-normal text-sm leading-[18.2px] text-[#101828]"
                      >Tell the gateman that package is...</span
                    >
                  </div>
                </TableCell>
                <TableCell>
        ...
        <TabsContent value="item-details" class="p-6">
          <div class="w-full lg:w-[60.09%]">
            ...
            <section class="mb-4">
              ...
              >
                Choose your package size or type your package size in the L x W
                x H custom field below
              </Label>
              <ToggleGroup
                type="single"
                class="grid grid-cols-2 gap-4 md:grid-cols-3 mt-4"
              >
                <ToggleGroupItem
                  value="standard-size"
                  class="h-[178.01px] rounded-xl border border-[#D9D9D9] py-4 bg-[#F7F8FA] toggle-focus"
                >
                  <div>
                    <section>
                      <div>
    ...
    <footer
      class="fixed right-0 left-0 bottom-0 flex justify-center border-t-[0.4px] border-[#DAD8D9] bg-white md:hidden py-2"
    >
      <Button
        class="w-[86%] h-[38px] rounded-md border border-[#D8D8D8] bg-[#1E1E1E]"
        @click="$router.push({ name: 'bulk-shipment-checkout' })"
      >

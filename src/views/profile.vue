<template>
  <div class="max-w-[880px]">
    <header class="flex justify-between items-center md:items-start">
      <back-button />
      <h2 :class="h2Class">Profile settings</h2>
    ...
    <!-- Profile pic -->
    <div
      class="flex justify-between items-center md:gap-x-9 md:justify-start mt-6 md:mt-12"
    >
    ...
    <!-- Personal info -->
    <h3 class="hidden md:block mt-12" :class="h3Class">Personal Information</h3>
    <Separator class="hidden md:block mt-4" />
    <!-- Basic Info -->
    <h4 class="mt-9 mb-1" :class="h4Class">Basic Information</h4>
    <Text> Manage your identity information </Text>
    <!-- Grid -->
    ...
    <!-- Contact number -->
    <h4 class="mt-9 mb-1" :class="h4Class">Contact number</h4>
    <Text> Manage your account phone number for updates </Text>
    <!-- Phone number  -->
    <div class="mt-6">
      <label
        class="block text-[13px] leading-[100%] font-medium text-[#26202B] mb-2"
      ...
      <div
        class="flex gap-x-4 justify-between items-center md:grid md:grid-cols-2"
      >
        <div class="w-full flex items-center border border-gray-300 rounded-lg">
          <div
            class="flex items-center justify-center py-[10px] pr-[12px] pl-[14px] h-[48px] border-r-2 border-[#E5E5E5] rounded-tl-lg rounded-bl-lg"
          >
    ...
    <!-- Contact email -->
    <h4 class="mt-9 mb-1" :class="h4Class">Contact email</h4>
    <Text> Manage your accounts email address for the invoices </Text>
    <!-- Email input -->
    <div class="mt-6">
      <label
        class="block text-[13px] leading-[100%] font-medium text-[#26202B] mb-2"
    ...
    <!-- Password -->
    <h4 class="mt-9 mb-1" :class="h4Class">Password</h4>
    <Text> Modify your current password </Text>
    <!-- Password input -->

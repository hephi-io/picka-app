        ...
        <form class="rounded-2xl border border-[#DFDFDF] p-6" @submit="handleSubmit">
          <header class="mb-10">
            ...
            <p class="outfit-normal font-normal text-base leading-[19.36px] text-[#26203B]">
              Verification successful. Experience the efficiency of Picka. Click 'Login' to access your dashboard.
            </p>

          </header>

          <section class="h-[183.63px] flex justify-center mb-10">
            <div class="w-[36.7%] h-full flex justify-center items-center">
          ...
          <button type="submit"
            ...
            <span class="outfit-bold font-bold text-base leading-[19.36px] text-white">Login</span>
          </button>
        </form>

...
const signupHandler = async (values) => {
  try {
    isSubmitting.value = true;
    if (!user.value.email || !user.value.password || !user.value.first_name || !user.value.last_name) {
    ...
    testSavedAcc.savedTestToken(response.data.data.activation_code);
        ...
        <div class="lg:w-[70%] lg:flex lg:items-center">
          <div class="lg:w-full">
            ...
            <div class="mb-[60px]">
              ...
              <div class="mb-6">
                ...
                <div class="flex rounded-xl p-1 bg-[#FFEFEC]">
                  <button :class="[
                    ...
                    <span :class="[isSignup ? activeSpanStyle : inactiveSpanStyle]">
                      Sign Up
                    </span>
                  </button>
                  ...
                  <button :class="[
                    ...
                    <span :class="[isSignin ? activeSpanStyle : inactiveSpanStyle]">
                      Sign In
                    </span>
                  </button>
                </div>
              ...
              <!-- Form register -->
              <Form v-if="isSignup" @submit="signupHandler" :validation-schema="signupSchema" v-slot="{ errors }">
                <!-- First Name -->
                <div class="mb-8" v-if="isSignup">
                  <!-- Label -->
                  <div class="mb-2">
                    <label for="FirstName">
                      <span class="font-medium text-base leading-[19.36px] text-[#26203B]">
                        First Name
                      </span>
                    </label>
                  </div>
                  ...
                  <!-- Field -->
                  <div>
                    <Field type="text" name="first_name" placeholder="First Name" v-model="user.first_name"
                ...
                <div class="mb-8" v-if="isSignup">
                  ...
                  <!-- Field -->
                  <div>
                    <Field type="text" name="last_name" placeholder="Last Name" v-model="user.last_name"
                      class="w-full rounded-xl px-4 py-2 border border-[#0F0F0F40] shadow-sm"
                ...
                <div class="mb-8">
                  ...
                  <!-- Field -->
                  <div>
                    <Field type="email" name="email" placeholder="Email" v-model="user.email"
                      class="w-full rounded-xl px-4 py-2 border border-[#0F0F0F40] shadow-sm"
                ...
                <div>
                  ...
                  <div class="mb-2">
                    ...
                    <!-- Field -->
                    <div>
                      <Field type="password" name="password" placeholder="Enter Password" v-model="user.password"
                        class="w-full rounded-xl px-4 py-2 border border-[#0F0F0F40] shadow-sm"
                  ...
                  <div>
                    <div class="flex gap-x-[9px] items-center mb-2">
                      ...
                      <div>
                        <span class="font-normal text-xs leading-3 text-[#5A5A5A]">
                  ...
                  <div class="mt-10">
                    <div class="mb-4">
                      <button type="submit"
                        ...
                        <Loader2 class="w-5 h-5 mr-2 animate-spin text-white" v-if="isSubmitting" />
              ...
              <!-- Form login -->
              <Form v-else @submit="handleLogin" :validation-schema="loginSchema" v-slot="{ errors }">
                <div class="space-y-8">
                  <!-- Email -->
                  <div class="mb-8">
                    <!-- Label -->
                    ...
                    <!-- Field -->
                    <div>
                      <Field name="email" type="email" placeholder="Email" v-model="user.email"
                        class="w-full rounded-xl px-4 py-2 border border-[#0F0F0F40] shadow-sm"
                        :class="{ 'border-red-500': errors.email }" />
                      <ErrorMessage name="email" class="text-red-500 text-sm mt-1" />
                    </div>
                  ...
                  <div>
                    ...
                    <div class="mb-2">
                      ...
                      <!-- Field -->
                      <div>
                        <Field name="password" type="password" placeholder="Enter Password" v-model="user.password"
                          class="w-full rounded-xl px-4 py-2 border border-[#0F0F0F40] shadow-sm"
                          :class="{ 'border-red-500': errors.password }" />
                        <ErrorMessage name="password" class="text-red-500 text-sm mt-1" />
                      </div>
            ...
            <div>
              ...
              <div class="mb-9">
                ...
                <div class="flex justify-center mb-4">
                  <div class="w-1/2 flex gap-x-1 items-center">
                    ...
                    <div>
                      <span class="font-medium text-xs leading-3 text-[#9C9AA530]">
                        OR
                      </span>
                    </div>
                ...
                <!-- Google -->
                <div>
                  <button class="w-full flex justify-center rounded-xl border py-4 border-[#E6E8E7] shadow-sm">
                    <div class="flex gap-x-2">
                      <div>
                        <span class="font-semibold text-lg leading-[21.6px] tracking-[-0.01em] text-[#232323]">
              ...
              <div>
                <div class="flex justify-center">
                  <span class="font-normal text-[13px] leading-[15.73px] text-[#9C9AA5] text-justify">
                    By signing up to create an account I accept Company’s
                  </span>
                </div>

                <div class="flex justify-center">
                  <span class="font-medium text-[13px] leading-[15.73px] text-[#26203B]">

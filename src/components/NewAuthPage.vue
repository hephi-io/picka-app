  ...
  <div class="p-8">
    ...
    <main class="flex justify-center">
      <section class="w-[36.3%]">
        ...
        <form class="rounded-2xl border border-[#DFDFDF] p-6" @submit.prevent="handleSubmit">
          ...
          <header class="mb-[60px]">
            ...
            <p class="outfit-normal font-normal text-base leading-[19.36px] text-[#26203B]">
              To proceed with your account setup, we require additional information to complete the verification
              process.
            </p>
          ...
          <section class="mb-[60px]">
            ...
            <section class="flex justify-between mb-8">
              ...
              <button disabled :class="[isPersonalAccount ? checkedStyle : uncheckedStyle]"
            ...
            <section class="mb-8">
              ...
              <section>
                <label for="phone-number"
                  class="outfit-medium font-medium text-base leading-[19.36px] text-[#26203B] mb-2">Phone Number</label>
              </section>
              ...
              <section class="flex justify-between">
                ...
                <section class="w-[31.4%] relative">
                  ...
                  <ul v-if="isDropDownOpen"
                    ...
                    <li v-for="(option, index) in options" :key="index" class="cursor-pointer hover:bg-[#F0F0F0] flex"
